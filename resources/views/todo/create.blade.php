...
@section('content')
    <div class="d-flex justify-content-between">
        ...
        <div>
            <a href="{{ route('todo.index') }}" class='btn btn-lg btn-warning'>Go back</a>
        </div>
    </div>
    <div id="validationErrors" style="color: red"></div>
    <form method="post" action="{{ route('todo.store') }}" id="todoForm">
        {{ csrf_field() }}
        ...
        <div class="form-group">
            ...
            <input type="date" id="date" min="{{ date('Y-m-d') }}" required class="form-control" name="date"
                required>
